...
-- Security note: demo accounts share Password@123 for local authentication testing only.
...
VALUES
(1, 'System Administrator', 'admin', 'admin@paragrein.local', '0700000001', '$2a$10$g6KUPMAxnM4iVvOuRnDuaehTRkdp3I1Uu9wWZuGhRYbdy2.fkDg7K', 2, 'ACTIVE', NULL, NOW(), NOW()),
(2, 'Finance Officer Demo', 'finance', 'finance@paragrein.local', '0700000002', '$2a$10$g6KUPMAxnM4iVvOuRnDuaehTRkdp3I1Uu9wWZuGhRYbdy2.fkDg7K', 3, 'ACTIVE', NULL, NOW(), NOW()),
(3, 'Pickup Agent Demo', 'pickup.agent', 'pickup.agent@paragrein.local', '0700000003', '$2a$10$g6KUPMAxnM4iVvOuRnDuaehTRkdp3I1Uu9wWZuGhRYbdy2.fkDg7K', 4, 'ACTIVE', NULL, NOW(), NOW()),
(4, 'Warehouse Staff Demo', 'warehouse.staff', 'warehouse.staff@paragrein.local', '0700000004', '$2a$10$g6KUPMAxnM4iVvOuRnDuaehTRkdp3I1Uu9wWZuGhRYbdy2.fkDg7K', 5, 'ACTIVE', NULL, NOW(), NOW()),
(5, 'Driver Demo', 'driver.demo', 'driver@paragrein.local', '0700000005', '$2a$10$g6KUPMAxnM4iVvOuRnDuaehTRkdp3I1Uu9wWZuGhRYbdy2.fkDg7K', 6, 'ACTIVE', NULL, NOW(), NOW()),
(6, 'Customer Demo', 'customer.demo', 'customer@paragrein.local', '0700000006', '$2a$10$g6KUPMAxnM4iVvOuRnDuaehTRkdp3I1Uu9wWZuGhRYbdy2.fkDg7K', 1, 'ACTIVE', NULL, NOW(), NOW()),
(7, 'Driver User', 'driver', 'driver@paragrein.local', '0700010011', '$2a$10$g6KUPMAxnM4iVvOuRnDuaehTRkdp3I1Uu9wWZuGhRYbdy2.fkDg7K', 6, 'ACTIVE', NULL, NOW(), NOW());
...
(5, 7, 'EMP-DRV-STAGE11', 'AVAILABLE', 'Delivery Driver', '2026-06-15', NOW(), NOW());
...
-- Business rule: one active pricing row is used as the default pricing baseline.
